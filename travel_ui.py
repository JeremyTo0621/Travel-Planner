...
if submitted and user_message.strip():
    with st.spinner("Planning your trip..."):
        ...
        try:
            ...
            data = resp.json()  # expects keys: itinerary, weather, rag_info, parsed_prompt
    ...
    with tab2:
        ...
        # Show a few extra weather details if present
        ...
        with meta_cols[1]:
            if "details" in weather and isinstance(weather["details"], dict):
                # e.g., current temperature from OpenWeather if available
                ...
                if temp is not None:
                    ...
                    st.write(temp)
        with meta_cols[2]:
            # Latitude/Longitude if available in details
